...
class Translator(object):
    """
    Uses a model to translate a batch of sentences.Ã Â¸Â°
    ...
    def translate(self,
        ...
        return all_scores, all_predictions, translations
    ...
    def _translate_batch(self, batch, data):
        ...
        for b in beam:
            ...
            if self.beam_accum is not None:
                ...
                self.beam_accum["log_probs"] = out.tolist()
